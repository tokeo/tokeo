"""
The Spiral fundi micro language model -- a small, complete, teachable lab.
...
The long-form walkthrough below (``FUNDI-LLM.md``) explains the training
pipeline, the anatomy of the weights, and constrained decoding with
diagrams.

.. include:: ./FUNDI-LLM.md
"""
